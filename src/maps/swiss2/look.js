...
export function makePhotoLook({ surfaces, ground, heights }) {
  ...
  const BUILDING = {
    ...
    /* The washes a village limes its houses in, and the colours their
     * window surrounds and friezes are painted: pale, chalky, faded. */
    renderCream: { group: 'render', tint: [0.62, 0.53, 0.37], normal: 2.2, weather: 'wall' },
    renderOchre: { group: 'render', tint: [0.62, 0.44, 0.21], normal: 2.2, weather: 'wall' },
    ...
    frescoGreen: { group: 'render', tint: [0.14, 0.22, 0.14], normal: 0.5, weather: 'wall' },
    frescoGrey: { group: 'render', tint: [0.2, 0.22, 0.24], normal: 0.5, weather: 'wall' },
    frescoOchre: { group: 'render', tint: [0.55, 0.36, 0.12], normal: 0.5, weather: 'wall' },
    ...
    roseWhite: { group: 'plain', tint: [0.7, 0.66, 0.6], rough: 0.8 },
