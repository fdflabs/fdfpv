...
| `colliders` | optional | a `Colliders`: trees within 700 m of the strip get a post (and beeches a canopy sphere), rocks a sphere, as nature.js does. 5,054 trees fall inside that radius on High |
